...
// ********************************************************************************************************************************************//
    ...
    Route::get('/start_date', [InnerJoinController::class, 'getJoinedData']);
    Route::get('/department', [InnerJoinController::class, 'getJoinedData']);
    Route::get('/section', [InnerJoinController::class, 'getJoinedData']);
    Route::get('/sub_section', [InnerJoinController::class, 'getJoinedData']);


    Route::get('/spkl-details', [InnerJoinController::class, 'getJoinedData']);
